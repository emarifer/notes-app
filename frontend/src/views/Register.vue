<template>
    <div class="container section">
        ...
        <form class="input-field row" @submit.prevent="signin">
            <input type="text" placeholder="Ingresa Nombre de Usuario…"
                ref="autofocus" v-model="user.name" required>
            <input type="email" placeholder="Ingresa Email…" v-model="user.email" required>
            ...
            <input type="text" placeholder="Ingresa Avatar…" v-model="user.avatar">
            <div class="section">
    ...
    export default {
        ...
        methods: {
            ...
            signin() {
                ...
                if (this.user.avatar === '') this.user.avatar = 'https://img.icons8.com/officel/2x/person-male.png';
